    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (DataModel item : list) {
                    ...
                    if (item.isCb_like()==true) {
                        // if the item is matched we are
                        // adding it to our filtered list.
                        filteredlist.add(item);
                    }
                }
                adapter = new myAdapter(filteredlist,allData.this,0);
        ...
        btn_heart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (DataModel item : list) {
                    // checking if the entered string matched with any item of our recycler view.
                    if (item.isCb_heart()==true) {
                        // if the item is matched we are
                        // adding it to our filtered list.
                        filteredlist.add(item);
                    }
                }
                adapter = new myAdapter(filteredlist,allData.this,1);
                rv_all.setAdapter(adapter);
            }
        });
        ...
        btn_all.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                adapter = new myAdapter(list,allData.this,2);
                rv_all.setAdapter(adapter);
            }
        });
